...
| 功能 | 状态 | 说明 |
|:--|:--|:--|
| Web 控制面板 | ✅ | `http://192.168.31.75:5000`，方向键控制小车 |
| 语音控制 | ✅ | 离线语音 ASR，"前进/后退/左转/右转/停止" |
| 系统信息显示 | ✅ | 电池电压、编码器、IMU、巡逻状态 |
| 底盘驱动 | ✅ | Rosmaster_Lib V1.5.8，桥直驱模式 |
| 启动健康检查 | ✅ | 自动检测 STM32 在线 |
| 端口固定 | ✅ | KERNELS udev 规则 |
| YOLO 目标检测 | ✅ | yolov5n 模型 |
| 激光雷达 | ✅ | YDLIDAR X4 |
| 摄像头 | ✅ | 320×240 MJPG |
| 巡逻状态机 | ✅ | IDLE/PATROL/ALERT |
...
|:--|:--|:--|
| 抓拍报警 | ❌ | 检测到目标后拍照推送 |
| SLAM 建图 | ❌ | Humble 容器按需启动 |
| 自动巡航 | ❌ | Nav2 waypoint follower |
| 自动避障 | ❌ | 依赖 SLAM 完成 |
